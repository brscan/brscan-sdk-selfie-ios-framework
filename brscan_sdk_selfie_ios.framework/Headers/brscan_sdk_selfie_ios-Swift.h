...
#ifndef BRSCAN_SDK_SELFIE_IOS_SWIFT_H
#define BRSCAN_SDK_SELFIE_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="brscan_sdk_selfie_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface UIButton (SWIFT_EXTENSION(brscan_sdk_selfie_ios))
